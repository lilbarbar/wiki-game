...
module Highway_System = struct
  ...
  module Connection = struct
    ...
    let of_string s =
      (* let open! Core in *)
      let new_s = String.substr_replace_all s ~pattern:"." ~with_:"" in
      let new_s = String.substr_replace_all new_s ~pattern:" " ~with_:"_" in
      ...
      let make_pair city1 city2 =
        City.of_string city1, City.of_string city2
      in
      let rec get_connections cities : (string * string) list =
